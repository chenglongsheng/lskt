...
MySQL - 5.7.29-32-log : Database - lskt_wechat
*********************************************************************
*/
...
CREATE
DATABASE /*!32312 IF NOT EXISTS*/`lskt_wechat` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert into `menu`(`id`, `parent_id`, `name`, `type`, `url`, `meun_key`, `sort`, `create_time`, `update_time`,
                   `is_deleted`)
values (1, 0, '直播', NULL, NULL, NULL, 1, '2021-11-24 08:41:53', '2021-11-24 08:44:55', 0),
